<template>
  <div class="col-sm-9">
    <h4>
      <small><b>Routing</b></small>
    </h4>
    <hr>
    <br>
    <p>
      Though user feel navigate from one page to another, in single page application everything load inside a one file (index.html).
      To simulate this behaviour we use routing. It does change part of the url and load the relavent content inside the index.html file.
    </p>
    <p>
    ...
    <ul>
      ...
      <ol>
        <li>To use vue router, we need to install "vue-router" package(if it is not install when we create the project using vue CLI).</li>
      ...
      <div class="mg-25">
        <p>When we create a router instance(calling the contructor method of the router class) can pass number of parameters,
         mode, baseurl, routes(array of objects). Single route object has in-build properties that we can use to define what
